...
static struct ctl_table ext4_sysctl_dir[] = {
	{
		.procname	= "ext4",
		.mode		= 0555,
		.child		= ext4_sysctls,
...
static struct ctl_table ext4_sysctl_root[] = {
	{
		.procname	= "fs",
		.mode		= 0555,
		.child		= ext4_sysctl_dir,
	},
	{ }
};
...
static int __init ext4_init_fs(void)
{
	...
	ext4_sysctl_table = register_sysctl_table(ext4_sysctl_root);
